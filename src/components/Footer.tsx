...
export default function Footer() {
  ...
  return (
    <footer className="bg-black border-t border-white/10 mt-auto pt-10 sm:pt-20 pb-24 sm:pb-10 relative z-40">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-4">
            {[
              ...
              { Icon: Camera, label: "Instagram Profile" },
              { Icon: AtSign, label: "Email Us" }
            ].map(({ Icon, label }, i) => (
              <a key={i} aria-label={label} className="h-10 w-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:bg-[hsl(40,86%,44%)] hover:text-white hover:border-transparent transition-all duration-300" href="#">
