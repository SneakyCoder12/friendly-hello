          ...
          <div className="flex flex-col items-center gap-5">
            ...
            <div className="relative w-[200px] h-[70px]">
              <img
                src="/dubai-plate.png"
                alt=""
                className="absolute top-0 left-0 w-[160px] h-auto object-contain -rotate-3 opacity-60"
              />
              <img
                src="/abudhabi-plate.png"
                alt=""
                className="absolute top-1 left-8 w-[160px] h-auto object-contain rotate-2 opacity-80"
              />
            </div>
            <Link
              to="/request"
